from fairlearn.reductions._moments.utility_parity import UtilityParity
from fairlearn.reductions._moments.moment import Moment,_LABEL,_GROUP_ID
...
class CDF_DemographicParity(Moment):
    ...
    def gamma(self,predictor):
        if isinstance(self.loss,SquareLoss):
            def classifier(X): 
